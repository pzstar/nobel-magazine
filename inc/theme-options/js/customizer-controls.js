jQuery(document).ready(function($) {
  ...
  var $eventSelect = $(".hs-select2-chooser");
  $eventSelect.select2();
  ...
  wp.customize("nobel_magazine_th_left_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var right_display = wp
          .customize("nobel_magazine_th_right_display")
          .get();
        if ("text" === setting.get() || "text" === right_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
    ...
    wp.customize.control("nobel_magazine_th_text", setupControl);
  });
  ...
  wp.customize("nobel_magazine_th_right_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        ...
        if ("text" === setting.get() || "text" === left_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
  ...
  wp.customize("nobel_magazine_th_left_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var right_display = wp
          .customize("nobel_magazine_th_right_display")
          .get();
        if ("menu" === setting.get() || "menu" === right_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
    ...
    wp.customize.control("nobel_magazine_th_menu", setupControl);
  });
  ...
  wp.customize("nobel_magazine_th_right_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var left_display = wp.customize("nobel_magazine_th_left_display").get();
        if ("menu" === setting.get() || "menu" === left_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
  ...
  wp.customize("nobel_magazine_th_left_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var right_display = wp
          .customize("nobel_magazine_th_right_display")
          .get();
        if ("widget" === setting.get() || "widget" === right_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
    ...
    wp.customize.control("nobel_magazine_th_widget", setupControl);
  });
  ...
  wp.customize("nobel_magazine_th_right_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var left_display = wp.customize("nobel_magazine_th_left_display").get();
        if ("widget" === setting.get() || "widget" === left_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
  ...
  wp.customize("nobel_magazine_th_left_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var right_display = wp
          .customize("nobel_magazine_th_right_display")
          .get();
        if ("social" === setting.get() || "social" === right_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
    ...
    wp.customize.control("nobel_magazine_social_link", setupControl);
  });
  ...
  wp.customize("nobel_magazine_th_right_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var left_display = wp.customize("nobel_magazine_th_left_display").get();
        if ("social" === setting.get() || "social" === left_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
  ...
  wp.customize("nobel_magazine_th_left_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var right_display = wp
          .customize("nobel_magazine_th_right_display")
          .get();
        if ("ticker" === setting.get() || "ticker" === right_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
    ...
    wp.customize.control("nobel_magazine_th_ticker_title", setupControl);
    wp.customize.control("nobel_magazine_th_ticker_category", setupControl);
  });
  ...
  wp.customize("nobel_magazine_th_right_display", function(setting) {
    var setupControl = function(control) {
      var visibility = function() {
        var left_display = wp.customize("nobel_magazine_th_left_display").get();
        if ("ticker" === setting.get() || "ticker" === left_display) {
          control.container.removeClass("customizer-hidden");
        } else {
          control.container.addClass("customizer-hidden");
        }
  ...
  */
  ...
  $("body").on(
    "click",
    ".nobel-magazine-customizer-icon-box .nobel-magazine-icon-list li",
    function() {
      var icon_class = $(this)
        .find("i")
        .attr("class");
      $(this)
        .closest(".nobel-magazine-icon-box")
        .find(".nobel-magazine-icon-list li")
        .removeClass("icon-active");
      $(this).addClass("icon-active");
      $(this)
        .closest(".nobel-magazine-icon-box")
        .prev(".nobel-magazine-selected-icon")
        .children("i")
        .attr("class", "")
        .addClass(icon_class);
      $(this)
  ...
  $("body").on(
    "click",
    ".nobel-magazine-customizer-icon-box .nobel-magazine-selected-icon",
    function() {
      $(this)
        .next()
        .slideToggle();
  ...
  $("body").on(
    "change",
    ".nobel-magazine-customizer-icon-box .nobel-magazine-icon-search select",
    function() {
      var selected = $(this).val();
      $(this)
        .closest(".nobel-magazine-icon-box")
        .find(".nobel-magazine-icon-search-input")
        .val("");
      $(this)
        .closest(".nobel-magazine-icon-box")
        .find(".nobel-magazine-icon-list li")
  ...
  $("body").on(
    "keyup",
    ".nobel-magazine-customizer-icon-box .nobel-magazine-icon-search input",
    function(e) {
      var $input = $(this);
      var keyword = $input.val().toLowerCase();
      search_criteria = $input
        .closest(".nobel-magazine-icon-box")
        .find(".nobel-magazine-icon-list.active i");
  ...
  $(".customize-control-range").each(function() {
    var sliderValue = $(this)
      .find(".slider-input")
      .val();
    var newSlider = $(this).find(".nobel-magazine-slider");
  ...
  $(".customize-control-range .nobel-magazine-slider").on("slide", function(
    event,
    ui
  ) {
    $(this)
  ...
  $(".customize-control-range .slider-reset").on("click", function() {
    ...
    $(this)
      .parents(".customize-control-range")
      .find(".slider-input")
      .val(resetValue);
    $(this)
      .parents(".customize-control-range")
      .find(".nobel-magazine-slider")
  ...
  $("body").on("click", ".nobel-magazine-add-control-field", function() {
    ...
    if (typeof $this != "undefined") {
      ...
      if (typeof field != "undefined") {
        ...
        field.find(".nobel-magazine-icon-list").each(function() {
          var defaultValue = $(this)
            .next("input[data-name]")
            .attr("data-default");
          $(this)
  ...
  $(".color-tab-switchers li").on("click", function() {
    ...
    $(this)
      .parent(".color-tab-switchers")
      .find("li")
      .removeClass("active");
    $(this).addClass("active");
    $(this)
      .closest(".color-tab-wrap")
      .find(".color-tab-contents > div")
      .hide();
    $(this)
      .closest(".color-tab-wrap")
      .find("." + clicked)
  ...
  api.controlConstructor["range-slider"] = wp.customize.Control.extend({
    ready: function() {
      ...
      jQuery("input.desktop-input").on("change keyup paste", function() {
        ...
        slider_input = $this
          .parent()
          .prev(".nobel-magazine-slider.desktop-slider");
      ...
      jQuery("input.tablet-input").on("change keyup paste", function() {
        ...
        slider_input = $this
          .parent()
          .prev(".nobel-magazine-slider.tablet-slider");
      ...
      jQuery("input.mobile-input").on("change keyup paste", function() {
        ...
        slider_input = $this
          .parent()
          .prev(".nobel-magazine-slider.mobile-slider");
...
jQuery(document).ready(function($) {
  ...
  // Linked button
  $(".nobel-magazine-linked").on("click", function() {
    // Set up variables
    var $this = $(this);
  ...
  // Unlinked button
  $(".nobel-magazine-unlinked").on("click", function() {
    // Set up variables
    var $this = $(this),
