...
if (class_exists('WP_Customize_Control')) {
                                ...
                                <div class="nobel-magazine-fields nobel-magazine-type-<?php echo esc_attr($field['type']) . ' ' . esc_attr($class); ?>">
                                    ...
                                    switch ($field['type']) {
                                        ...
                                        case 'checkbox':
                                            ...
                                            echo '<div class="nm-onoff-switch">';
                                            echo '<label class="nm-onoff-switch-label ' . esc_attr($checkbox_class) . '">';
                                            echo '<input class="nm-onoff-switch-checkbox" data-default="' . esc_attr($default) . '" value="' . esc_attr($new_value) . '" data-name="' . esc_attr($key) . '" type="checkbox" ' . checked($new_value, 'yes', false) . '/>';
                                            echo '</label>';
                                            echo '</div>';
                                            if (!empty($label)) {
                                                echo '<span class="customize-control-title nm-onoff-switch-title">' . esc_html($label) . '</span>';
                                            }
                                        ...
                                        case 'range':
                                            ...
                                            echo '<div class="nobel-magazine-nm-responsive-range-slider" >';
                                        ...
                                        case 'icon':
                                            echo '<div class="nm-icon-box-wrap">';
                                            echo '<div class="nm-selected-icon">';
                                            echo '<i class="' . esc_attr($new_value) . '"></i>';
                                            echo '<span><i class="icofont-simple-down"></i></span>';
                                            echo '</div>';
                                            echo '<div class="nm-icon-box">';
                                            echo '<div class="nm-icon-search">';
                                            echo '<select>';
                                            ...
                                            echo '</select>';
                                            echo '<input type="text" class="nm-icon-search-input" placeholder="' . esc_html__('Type to filter', 'nobel-magazine') . '" />';
                                            echo '</div>';

                                            if (apply_filters('nobel_magazine_show_ico_font', true)) {
                                                echo '<ul class="nm-icon-list icofont-list clearfix active">';
                                            ...
                                            if (apply_filters('nobel_magazine_show_material_icon', true)) {
                                                echo '<ul class="nm-icon-list material-icon-list clearfix">';
                                            ...
                                            if (apply_filters('nobel_magazine_show_elegant_icon', true)) {
                                                echo '<ul class="nm-icon-list elegant-icon-list clearfix">';
        ...
        public function render_content() {
            ...
            <div class="simple-notice-custom-control">
                <?php if (!empty($this->label)) { ?>
                    <span class="customize-control-title nm-customizer-heading"><?php echo esc_html($this->label); ?></span>
                <?php } ?>
            </div>
            <?php
        }
    ...
    class Nobel_Magazine_Select2_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <label>
                ...
                <select class="nm-select2-chooser" multiple="multiple">
                    <?php
    ...
    /** Icon Chooser */
    class Nobel_Magazine_Icon_Selector extends WP_Customize_Control {

        public $type = 'nm-icon-selector';
        ...
        public function render_content() {
            ...
            <label>
                ...
                <div class="nm-icon-box-wrap">
                    <div class="nm-selected-icon">
                    ...
                    <div class="nm-icon-box">
                        <div class="nm-icon-search">
                            <input type="text" class="nm-icon-search-input" placeholder="<?php echo esc_html__('Type to filter', 'nobel-magazine'); ?>" />
                        </div>

                        <ul class="nm-icon-list clearfix active">
                            <?php
                            if (isset($this->icon_array) && !empty($this->icon_array)) {
                                $icon_array = $this->icon_array;
                            } else {
                                $icon_array = nobel_magazine_eleganticons_array();
                            }
    ...
    class Nobel_Magazine_Multiple_Select extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <label>
                ...
                <select data-placeholder="<?php echo esc_attr($this->placeholder); ?>" multiple="multiple" class="nm-chosen-select" <?php $this->link(); ?>>
                    <?php
                    foreach ($this->choices as $value => $label) {
                        $selected = '';
    ...
    class Nobel_Magazine_Image_Selector extends WP_Customize_Control {
        ...
        public function render_content() {
            if (!empty($this->choices)) {
                ...
                <label>
                    ...
                    <select class="nm-image-selector" <?php $this->link(); ?>>
                        <?php
                    ...
                    <div class="nm-image-container"><img src="<?php echo $this->image_path . $this->value(); ?>.png"/></div>
                </label>
                <?php
            }
        }
    ...
    /** Switch Control */
    class Nobel_Magazine_Switch extends WP_Customize_Control {

        public $type = 'nm-switch';
    ...
    /** Info Text Control */
    class Nobel_Magazine_Text_Info extends WP_Customize_Control {
    ...
    /** Alpha Color Control */
    class Nobel_Magazine_Alpha_Color extends WP_Customize_Control {

        /**
         * Official control name.
         */
        public $type = 'nm-alpha-color';
        ...
        public function render_content() {
            ...
            <input class="nm-alpha-color-control" data-alpha="<?php echo esc_attr($show_opacity); ?>" type="text" data-palette="<?php echo esc_attr($palette); ?>" data-default-color="<?php echo esc_attr($this->settings['default']->default); ?>" <?php $this->link(); ?>  />
            <?php
        }
    ...
    /** Checkbox Control */
    class Nobel_Magazine_Toggle extends WP_Customize_Control {
        ...
        public function render_content() {
            ?>
            <div class="nm-toggle">
                <div class="nm-onoff-switch">
                    <input type="checkbox" id="<?php echo esc_attr($this->id); ?>" name="<?php echo esc_attr($this->id); ?>" class="nm-onoff-switch-checkbox" value="<?php echo esc_attr($this->value()); ?>" <?php $this->link(); ?> <?php checked($this->value()); ?>>
                    <label class="nm-onoff-switch-label" for="<?php echo esc_attr($this->id); ?>"></label>
                </div>
                <span class="customize-control-title nm-onoff-switch-title"><?php echo esc_html($this->label); ?></span>
                <?php if (!empty($this->description)) { ?>
                    <span class="description customize-control-description">
                        <?php echo wp_kses_post($this->description); ?>
                    </span>
    ...
    /** Separator Control */
    class Nobel_Magazine_Separator extends WP_Customize_Control {
    ...
    class Nobel_Magazine_Gradient_Selector extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            $html = '<div class="nm-gradient-box" data-default-color="' . esc_attr($default_color) . '">';

            // Classy Gradient Picker
            $html .= '<div class="nm-gradient-row">';
            $html .= '<div class="nm-gradient-label">' . esc_html($picker_label) . '</div>';
            $html .= '<div class="nm-gradient-picker"></div>';
            $html .= '<div class="nm-gradient-description">' . esc_html($picker_description) . '</div>';
            $html .= '</div>';

            // Gradient Linear Direction Selector
            $html .= '<div class="nm-gradient-row">';
            $html .= '<div class="nm-gradient-label">' . esc_html($angle_label) . '</div>';
            $html .= '<select class="nm-gradient-direction">
            ...
            $html .= '<div class="nm-gradient-row">';
            $html .= '<div class="nm-gradient-custom" style="display: none;">';
            $html .= '<div class="nm-gradient-label">' . esc_html__('Define Custom Angle', 'nobel-magazine') . '</div>';
            $html .= '<div class="nm-gradient-angle-slider">';
            $html .= '<div class="nm-gradient-range"></div>';
            $html .= '</div>';
            $html .= '</div>';
            $html .= '</div>';
            ...
            $html .= '<div class="nm-gradient-row">';
            $html .= '<div class="nm-gradient-label">' . esc_html($preview_label) . '</div>';
            $html .= '<div class="nm-gradient-preview"></div>';
            $html .= '</div>';
            echo $html;
            ?>
            <input type="hidden" class="<?php echo esc_attr($type) . ' ' . esc_attr($class) ?> nm-gradient-val"  value="<?php echo esc_attr($this->value()) ?>" <?php $this->link(); ?> />
            </div>
            <?php
        }
    ...
    /** Background Control */
    class Nobel_Magazine_Background_Image extends WP_Customize_Upload_Control {
    ...
    /** Control Tab */
    class Nobel_Magazine_Tab extends WP_Customize_Control {
        ...
        public function content_template() {
            ?>
            <div class="nm-customizer-tab-wrap">
                <# if ( data.buttons ) { #>
    ...
    class Nobel_Magazine_Date_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <label>
                ...
                <input class="nm-datepicker" type="text" autocomplete="off" value="<?php echo esc_attr($this->value()); ?>" <?php $this->link(); ?>>
            </label>
            <?php
        }
    ...
    class Nobel_Magazine_Dimensions_Control extends WP_Customize_Control {
        ...
        protected function content_template() {
            ...
            <ul class="desktop control-wrap active">
                ...
                <li class="nm-dimension-wrap {{ key }}">
                    <input {{{ data.inputAttrs }}} type="number" class="nm-dimension-{{ key }}" {{{ args.link }}} value="{{{ args.value }}}" />
                        <span class="nm-dimension-label">{{ data.l10n[ key ] }}</span>
                </li>
                <# } ); #>

                <li class="nm-dimension-wrap">
                    <div class="nm-link-dimensions">
                        <span class="dashicons dashicons-admin-links nm-linked" data-element="{{ data.id }}" title="{{ data.title }}"></span>
                        <span class="dashicons dashicons-editor-unlink nm-unlinked" data-element="{{ data.id }}" title="{{ data.title }}"></span>
                    </div>
                </li>
            </ul>
            ...
            <ul class="tablet control-wrap">
                ...
                <li class="nm-dimension-wrap">
                    <div class="nm-link-dimensions">
                        <span class="dashicons dashicons-admin-links nm-linked" data-element="{{ data.id }}_tablet" title="{{ data.title }}"></span>
                        <span class="dashicons dashicons-editor-unlink nm-unlinked" data-element="{{ data.id }}_tablet" title="{{ data.title }}"></span>
                    </div>
                </li>
            </ul>
            ...
            <ul class="mobile control-wrap">
                ...
                <li class="nm-dimension-wrap">
                    <div class="nm-link-dimensions">
                        <span class="dashicons dashicons-admin-links nm-linked" data-element="{{ data.id }}_mobile" title="{{ data.title }}"></span>
                        <span class="dashicons dashicons-editor-unlink nm-unlinked" data-element="{{ data.id }}_mobile" title="{{ data.title }}"></span>
                    </div>
                </li>
            </ul>
    ...
    /** Range Control */
    class Nobel_Magazine_Range_Slider extends WP_Customize_Control {

        /**
         * The type of control being rendered
         */
        public $type = 'nm-range-slider';
        public $unit = '';
        ...
        public function render_content() {
            ...
            <span class="customize-control-title">
                <?php echo esc_html($this->label); ?>
                <span class="nm-slider-reset dashicons dashicons-image-rotate" slider-reset-value="<?php echo esc_attr($this->value()); ?>"></span>
            </span>

            <div class="control-wrap"> 
                <div class="nm-range-slider" slider-min-value="<?php echo esc_attr($this->input_attrs['min']); ?>" slider-max-value="<?php echo esc_attr($this->input_attrs['max']); ?>" slider-step-value="<?php echo esc_attr($this->input_attrs['step']); ?>"></div>
    ...
    class Nobel_Magazine_Responsive_Range_Slider extends WP_Customize_Control {
        ...
        protected function content_template() {
            ...
            <div class="desktop control-wrap active">
                <div class="nm-res-range-slider desktop-slider"></div>
            ...
            <div class="tablet control-wrap">
                <div class="nm-res-range-slider tablet-slider"></div>
                <div class="nm-res-range-slider-input">
            ...
            <div class="mobile control-wrap">
                <div class="nm-res-range-slider mobile-slider"></div>
                <div class="nm-res-range-slider-input">
    ...
    /** Sortable Control */
    class Nobel_Magazine_Sortable extends WP_Customize_Control {
        ...
        protected function content_template() {
            ...
            <label class='nm-sortable-label'>
                ...
                <ul class="nm-sortable">
                    <# _.each( data.value, function( choiceID ) { #>
                    <li {{{ data.inputAttrs }}} class='nm-sortable-item' data-value='{{ choiceID }}'>
                    ...
                    <li {{{ data.inputAttrs }}} class='nm-sortable-item invisible' data-value='{{ choiceID }}'>
                        <i class='dashicons dashicons-menu'></i>
                        <i class="dashicons dashicons-visibility visibility"></i>
                        {{{ data.choices[ choiceID ] }}}
                    </li>
    ...
    class Nobel_Magazine_Color_Tab extends WP_Customize_Control {
        ...
        protected function content_template() {
            ...
            <span class="customize-control-title">
                ...
                <div class="nm-color-tab-toggle"><span class="dashicons dashicons-edit"></span></div>
            </span>
            <# } #>
            ...
            <div class="nm-color-tab-wrap" style="display:none">
                <ul class="nm-color-tab-switchers">
                    <li data-tab="nm-color-tab-content-normal" class="active">{{{ data.l10n['normal'] }}}</li>
                    <li data-tab="nm-color-tab-content-hover">{{{ data.l10n['hover'] }}}</li>
                </ul>

                <div class="nm-color-tab-contents">
                    <div class="nm-color-tab-content-normal" style="display:block">
                        <# _.each( data.normal, function( args, key ) { #>
                        <div class="color-content-wrap {{ key }}">
                            <label class="nm-color-tab-label">{{ data.group[ key ] }}</label>
                            <input class="nm-alpha-color-control" type="text" value="{{ args.value }}" data-alpha="{{ data.show_opacity }}" data-default-color="{{ args.default }}" data-palette="{{ data.palette }}" {{{ args.link }}} />   
                        </div>
                        <# } ); #>
                    </div>

                    <div class="nm-color-tab-content-hover" style="display:none">
...
if (class_exists('WP_Customize_Section')) {
    ...
    class Nobel_Magazine_Toggle_Section extends WP_Customize_Section {
         ...
         */
        public function enqueue() {
            wp_enqueue_script('nm-toggle-section', get_template_directory_uri() . '/inc/customizer/js/toggle-section.js', array('jquery'), '1.0', true);
        }
        ...
        protected function render_template() {
            ...
            <li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }}">
                <h3 class="accordion-section-title <# if ( data.hide != 'on' ) { #> nobel-magazine-section-visible <# } else { #> nobel-magazine-section-hidden <# }#>" tabindex="0">
                    {{ data.title }}
                    <# if ( data.hide != 'on' ) { #>
                    <a data-control="{{ data.hiding_control }}" class="nm-toggle-section" href="#"><span class="dashicons dashicons-visibility"></span></a>
                    <# } else { #>
                    <a data-control="{{ data.hiding_control }}" class="nm-toggle-section" href="#"><span class="dashicons dashicons-hidden"></span></a>
                    <# } #>
                </h3>
